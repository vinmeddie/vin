...
{
$ui= mysql_query("SELECT * FROM m_chat WHERE id='".$_GET['id']."' ") or die(mysql_error()); 
$rrrr=mysql_fetch_assoc($ui);


mysql_query("INSERT INTO m_comments VALUES('','".$_GET['id']."','".$_SESSION['uid']."','".$mess."',now())") or die(mysql_error());
mysql_query("INSERT INTO m_not VALUES('','".$_GET['id']."','".$_SESSION['uid']."',now(),'".$rrrr['user']."')") or die(mysql_error());
 ...
 <?php include('header.php')?>
  ...
  <div class="content">
	...
	?>
		...
		$sql = mysql_query("SELECT * FROM m_chat WHERE id='".$_GET['id']."' ") or die(mysql_error()); 
$i = 0;
