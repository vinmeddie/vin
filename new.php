...
<div class="container">
 ...
 <?php include('header.php')?>
  ...
  <div class="content">
	...
	<tr><td align="left">
	<p><font size="3" color='white'><b><?php echo $limit;?> Newly Registered Members</b></font></p>
	</td></tr>
...
$sqlk = mysql_query("SELECT * FROM users") or die(mysql_error()); 
$no=mysql_num_rows($sqlk);
	...
	<input class="search" type='submit' name='go' value='Go'></p>
		...
		$sql = mysql_query("SELECT * FROM users WHERE username!='NUll' ORDER BY id DESC LIMIT $limit ") or die(mysql_error()); 
$i = 0;
